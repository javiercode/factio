    ...
    <div class="">
        <div class="page-title">
            <div class="title_left">
                <h3><i class="fa fa-search"></i> Administración / Roles </h3>
            </div>
                        ...
                        <div class="right">
                            <div class="col-md-2">
                                ...
                                <button type="button" class="btn btn-sm btn-success btn-block" data-toggle="modal"
                                        data-target="#mAddItem"><i class="fa fa-plus"></i>Nueva Campaña
                                </button>
                            </div>
                        </div>
                        <div class="clearfix"></div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped jambo_table bulk_action">
                                ...
                                <tbody class="tbody-busqueda">
                                   ...
                                   <tr>
                                       <td>{{$i++}}
                                           <input type="hidden" name="pk" value="<?= $oUser['id']?>">
                                           <input type="hidden" name="status" value="<?= $oUser['status']?>">
                                       </td>
                                       <td>
                                           <?= $oUser['username']?>
                                           <small class="legend-status">
                                       ...
                                       <td><?= $oUser['type']?></td>
                                       <td><?= $oUser['branch']?></td>
                                       <td><?= $oUser['discount'] ?><?=  $oUser['discount_type']=='PRECIO'? '(Moneda)':'(%)' ?></td>
                                       <td><?= $oUser['description']?></td>
                                       <td>
...
<div class="modal fade" id="mEditItem" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form class="form-horizontal form-label-left" id="formEdit" action="{{ url('/param/bell/create') }}" data-toggle="validator" role="form">
...
<div class="modal fade" id="mAddItem" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form class="form-horizontal form-label-left" id="formAdd" action="{{ url('param/bell/create') }}" data-toggle="validator" role="form">
