                        ...
                        <div class="table-responsive">
                            <table class="table table-striped jambo_table bulk_action">
                                ...
                                <tbody class="tbody-busqueda">
                                   <?php
                                    $i=1;
                                    foreach ($aPerson as $oPerson){
                                        ?>
                                   <tr>
                                       <td>{{$i++}}
                                           <input type="hidden" name="pk" value="{{ $oPerson['id']}}">
                                           <input type="hidden" name="status" value="{{ $oPerson['status']}}">
                                       </td>
                                       <td><?= $oPerson['first_name']?></td>
                                       <td><?= $oPerson['second_name']?></td>
                                       <td><?= $oPerson['first_lastname']?></td>
                                       <td><?= $oPerson['second_lastname']?></td>
                                       <td><?= $oPerson['ci']?></td>
                                       <td><?= $oPerson['gender']?></td>
                                       <td>
...
<div class="modal fade" id="mAddItem" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form class="form-horizontal form-label-left" id="formAdd" action="{{ url('admin/person/create') }}" data-toggle="validator" role="form">
            {{--<form class="form-horizontal form-label-left" id="formAdd" action="#" data-toggle="validator" role="form" onsubmit="return false">--}}
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-primary btn-activo">Guardar</button>
                </div>
            </form>
        </div>
    </div>
