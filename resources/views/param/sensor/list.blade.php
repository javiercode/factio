    ...
    <div class="">
        <div class="page-title">
            <div class="title_left">
                <h3><i class="fa fa-search"></i> Control / Beneficiario </h3>
            </div>
                        ...
                        <div class="right">
                            <div class="col-md-2">
                                ...
                                <button type="button" class="btn btn-sm btn-success btn-block" data-toggle="modal"
                                        data-target="#mAddItem"><i class="fa fa-plus"></i>Adicionar
                                </button>
                            </div>
                        </div>
                        <div class="clearfix"></div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped jambo_table bulk_action">
                                ...
                                <tbody class="tbody-busqueda">
                                   ...
                                   <tr>
                                       <td>{{$i++}}
                                           <input type="hidden" name="pk" value="{{ $oSensor['id']}}">
                                           <input type="hidden" name="status" value="{{ $oSensor['status']}}">
                                       </td>
                                       <td>
                                           <small>
                                               <strong><?= $oSensor['detalle']?> </strong><br>
                                               <strong>codigo: </strong><?= $oSensor['codigo']?>
                                           </small>
                                       </td>
                                       <td>
                                           <small>
                                               <strong><?= $oSensor['ubicacion']?> </strong><br>
                                               <strong>Latitud: </strong><?= $oSensor['latitud']?><br>
                                               <strong>Longitud: </strong><?= $oSensor['longitud']?>
                                           </small>
                                       </td>
                                       <td><?= $oSensor['tipo']?></td>
                                       <td><?= $oSensor['descripcion']?></td>
                                       <td>
...
<div class="modal fade" id="mAddItem" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form class="form-horizontal form-label-left" id="formAdd" action="{{ url('param/sensor/create') }}" data-toggle="validator" role="form">
